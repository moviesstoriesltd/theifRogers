...
// the SVG still get a real icon. Renders the same logo glyph as /logo.svg on
// the brand navy so the favicon is identical across every browser.
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img src={LOGO_DATA_URI} width={300} height={300} alt="" />
      </div>
    ),
    { ...size }
  );
